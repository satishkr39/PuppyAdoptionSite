...
class RequestValidator(object):
    ...
    * @realms -> [list, of, realms]
    ...
    client key or resource owners key is invalid. Instead dummy values should
    ...
    equivalent to the running time when given a valid client/resource owners.
    ...
    * @dummy_access_token
    ...
    def validate_verifier(self, client_key, token, verifier, request):
        ...
        resource owners authorizes access. This code is used by the client to
