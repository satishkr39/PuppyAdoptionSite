...
class AuthorizationEndpoint(BaseEndpoint):
    ...
    from the resource owners via user-agent redirection.

    The authorization endpoint is used to interact with the resource
    owners and obtain an authorization grant.  The authorization server
    MUST first verify the identity of the resource owners.  The way in
    which the authorization server authenticates the resource owners (e.g.
