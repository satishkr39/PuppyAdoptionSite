...
class AuthorizationCodeGrant(GrantTypeBase):
    ...
    interacting with the resource owners's user-agent (typically a web
    ...
    def create_authorization_response(self, request, token_handler):
        ...
        The client directs the resource owners to the constructed URI using an
        ...
        try:
            ...
            log.debug('Pre resource owners authorization validation ok for %r.',
                      request)
