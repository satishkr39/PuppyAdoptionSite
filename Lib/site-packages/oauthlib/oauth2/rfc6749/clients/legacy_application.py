...
class LegacyApplicationClient(Client):
    ...
    """A public client using the resource owners password and username directly.
    ...
    The method through which the client obtains the resource owners
    ...
    def prepare_request_body(self, username, password, body='', scope=None, **kwargs):
        """Add the resource owners password and username to the request body.

        The client makes a request to the token endpoint by adding the
        following parameters using the "application/x-www-form-urlencoded"
        format per `Appendix B`_ in the HTTP request entity-body:

        :param username:    The resource owners username.
        :param password:    The resource owners password.
