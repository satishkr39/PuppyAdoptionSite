...
class RequestValidator(object):
    ...
    def save_authorization_code(self, client_id, code, request, *args, **kwargs):
        ...
        The code should at minimum be stored with:
            ...
            - a resource owners / user (request.user)
    ...
    def validate_bearer_token(self, token, scopes, request):
        ...
        Note, the request.user attribute can be set to the resource owners
    ...
    def validate_code(self, client_id, code, client, request, *args, **kwargs):
        ...
        OBS! The request.user attribute should be set to the resource owners
    ...
    def validate_user(self, username, password, client, request, *args, **kwargs):
        ...
        to a valid resource owners, i.e. request.user = username or similar. If
