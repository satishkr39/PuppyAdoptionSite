...
class OAuth2RequestValidator(RequestValidator):
    ...
    def confirm_scopes(self, refresh_token, scopes, request, *args, **kwargs):
        ...
        by the resource owners. If the scope is omitted it is treated as equal
        to the scope originally granted by the resource owners.
    ...
    def validate_refresh_token(self, refresh_token, client, request,
        ...
        issuing refresh tokens, resource owners password credentials grant
